...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("    Задание 3: проверить ");
        ...
        System.out.println(main.is2Digits(-52));
        ...
        System.out.println("    Задание 5: ");
        int[] arr6 = {1, 2, 3, 4, 5};
        System.out.println("      Массив чисел №1: " + Arrays.toString(arr6));
        int[] ins = {7, 8, 9};
        System.out.println("      Массив чисел №2: " + Arrays.toString(ins));
        int pos = 3;
        System.out.println("      Вводные данные: " + pos);
        ...
        System.out.println("    Задание 7: ");
        int[] arr7 = {1, 2, 3, 4, 5};
        System.out.println("      Массив чисел: " + Arrays.toString(arr7));
        ...
        System.out.println("      Массив чисел: " + Arrays.toString(arr5));
        int xx = 2;
        System.out.println("      Вводные данные: " + xx);
